    ...
    var wanDouJiaExt = {
        ...
        modifyGlobalPage:function(){
            ...
            if ( $(".jds .an a").length > 0 ){
                ...
                var down_link = download_link + "#name=" + name + "&content-type=apk";
                self.attr("href",down_link).attr("download","");
            }
        },
        modifyDownloadList:function(){
            ...
            if(items.length > 0){
                items.each(function(){
                    ...
                    var down_link = "http://res.read.ifeng.com/book/apk/IfengOpenBook_"+book_id+".apk" + "#name=" + name + "&content-type=apk";
                    //self.attr("href",down_link).attr("download","");
