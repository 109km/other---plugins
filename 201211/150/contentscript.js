    ...
    var wanDouJiaExt = {
        ...
        modifyGlobalPages:function(){
            ...
            items.each(function(){
                ...
                self.find('.dwn a').attr("href",new_href).attr("download","");
                self.find('.dwn a').removeAttr("onclick");
            });
        ...
        modifyDetailPage:function(){
            ...
            down_video.attr("href",new_down_href).attr("download","");
            down_video.attr("onclick","");
