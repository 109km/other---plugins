            ...
            if (embed.length > 0){
                embed.each(function(){
                    var self = $(this),
                        ...
                        flashvars = self.attr('flashvars');

                    var new_obj = '<object data=' + src + ' id="yinyuetaiplayer" width="100%" height="100%" codetype="application/x-shockwave-flash">\
                                                <param name="flashvars" value="'+flashvars+'" />\
                                                <param name="wmode" value="opaque" /><param name="allowFullScreen" value="true"><param name="allowscriptaccess" value="always">\
                                          </object>';

                    self.replaceWith(new_obj);
