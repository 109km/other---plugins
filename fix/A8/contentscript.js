    ...
    var wanDouJiaExt = {
        ...
        removeA8Element: function () {
            ...
            if (this.tabName == 'a8-rank') {
                var items = $(".rank_list_730 li");
                items.each(function(){
                    var song_url = $(this).find(".songInfo a").first().attr("href"),
                        down = $(this).find(".down");
                    down.html("进入下载页面");
                    down.attr("href",song_url);
                ...
                $('ul.rank_list_730 li .singer a').removeAttr('href');
                $('div.partner').hide();
                $('div.friendlink').hide();
                ...
                $('.song_listBox .song').each(function(){
                    $(this).find("a").last().attr('href', 'javascript:void();');
                });
